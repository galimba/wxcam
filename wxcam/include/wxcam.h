...
class wxCam : public wxFrame {
    public:
        ...
        void OnSettingVerticalMirror(wxCommandEvent& event);
        void OnSettingInstagram(wxCommandEvent& event);
        void OnSettingStretch(wxCommandEvent& event);
        void OnSettingEdgeAsm(wxCommandEvent& event);
        void OnSettingBonaAsm(wxCommandEvent& event);
        void OnSettingPixelate(wxCommandEvent& event);
        void OnSettingMedian(wxCommandEvent& event);
        void OnSettingMedianAsm(wxCommandEvent& event);
        void OnSettingBlueOnlyAsm(wxCommandEvent& event);
        void OnSettingMonoAsm(wxCommandEvent& event);
        void OnSettingNegativeAsm(wxCommandEvent& event);
