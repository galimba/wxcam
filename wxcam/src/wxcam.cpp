...
EVT_MENU( VerticalMirror_Filter, wxCam::OnSettingVerticalMirror )
EVT_MENU( Instagram_Filter, wxCam::OnSettingInstagram )
EVT_MENU( Stretch_Filter, wxCam::OnSettingStretch )
EVT_MENU( EdgeAsm_Filter, wxCam::OnSettingEdgeAsm )
EVT_MENU( BonaAsm_Filter, wxCam::OnSettingBonaAsm )
EVT_MENU( Pixelate_Filter, wxCam::OnSettingPixelate )
EVT_MENU( Median_Filter, wxCam::OnSettingMedian )
EVT_MENU( MedianAsm_Filter, wxCam::OnSettingMedianAsm )
EVT_MENU( BlueOnlyAsm_Filter, wxCam::OnSettingBlueOnlyAsm )
EVT_MENU( MonoAsm_Filter, wxCam::OnSettingMonoAsm )
EVT_MENU( NegativeAsm_Filter, wxCam::OnSettingNegativeAsm )
...
{    
    ...
    menuFilters->AppendCheckItem( Median_Filter, _( "&Median_C++" ) );
    menuFilters->Check(Median_Filter, Setting::GetInstance()->GetMedian());
    menuFilters->AppendSeparator();
    menuFilters->AppendCheckItem( VerticalMirror_Filter, _( "&Vertical Mirror (ASM)" ) );
    menuFilters->Check(VerticalMirror_Filter, Setting::GetInstance()->GetVerticalMirror());
    menuFilters->AppendCheckItem( Instagram_Filter, _( "&Instagram (ASM)" ) );
    menuFilters->Check(Instagram_Filter, Setting::GetInstance()->GetInstagram());
    menuFilters->AppendCheckItem( Stretch_Filter, _( "&Stretch Filter(ASM)" ) );
    menuFilters->Check(Stretch_Filter, Setting::GetInstance()->GetStretch());
    menuFilters->AppendCheckItem( EdgeAsm_Filter, _( "&Edge (ASM)" ) );
    menuFilters->Check(EdgeAsm_Filter, Setting::GetInstance()->GetEdgeAsm());
    menuFilters->AppendCheckItem( BonaAsm_Filter, _( "&Bona (ASM)" ) );
    menuFilters->Check(BonaAsm_Filter, Setting::GetInstance()->GetBonaAsm());
    menuFilters->AppendCheckItem( Pixelate_Filter, _( "&Pixelate (ASM)" ) );
    menuFilters->Check(Pixelate_Filter, Setting::GetInstance()->GetPixelate());
    menuFilters->AppendCheckItem( NegativeAsm_Filter, _( "&Negative (ASM)" ) );
    menuFilters->Check(NegativeAsm_Filter, Setting::GetInstance()->GetNegativeAsm());
    menuFilters->AppendCheckItem( MonoAsm_Filter, _( "&Monochrome (ASM)" ) );
    menuFilters->Check(MonoAsm_Filter, Setting::GetInstance()->GetMonoAsm());
    menuFilters->AppendCheckItem( BlueOnlyAsm_Filter, _( "&Channel Filter (ASM)" ) );
    menuFilters->Check(BlueOnlyAsm_Filter, Setting::GetInstance()->GetBlueOnlyAsm());
    menuFilters->AppendCheckItem( MedianAsm_Filter, _( "&Median (ASM)" ) );
    menuFilters->Check(MedianAsm_Filter, Setting::GetInstance()->GetMedianAsm());
    menuFilters->AppendSeparator(); 
    menuFilters->AppendSeparator(); 
...
void wxCam::OnSettingVerticalMirror(wxCommandEvent& event)
{
    Setting::GetInstance()->SetVerticalMirror(event.IsChecked());
}

void wxCam::OnSettingInstagram(wxCommandEvent& event)
{
    Setting::GetInstance()->SetInstagram(event.IsChecked());
}

void wxCam::OnSettingStretch(wxCommandEvent& event)
{
    Setting::GetInstance()->SetStretch(event.IsChecked());
}

void wxCam::OnSettingEdgeAsm(wxCommandEvent& event)
{
    Setting::GetInstance()->SetEdgeAsm(event.IsChecked());
}

void wxCam::OnSettingBonaAsm(wxCommandEvent& event)
{
    Setting::GetInstance()->SetBonaAsm(event.IsChecked());
}

void wxCam::OnSettingPixelate(wxCommandEvent& event)
{
    Setting::GetInstance()->SetPixelate(event.IsChecked());
}

void wxCam::OnSettingMedian(wxCommandEvent& event)
{
    Setting::GetInstance()->SetMedian(event.IsChecked());
}

void wxCam::OnSettingMedianAsm(wxCommandEvent& event)
{
    Setting::GetInstance()->SetMedianAsm(event.IsChecked());
}

void wxCam::OnSettingBlueOnlyAsm(wxCommandEvent& event)
{
    Setting::GetInstance()->SetBlueOnlyAsm(event.IsChecked());
}

void wxCam::OnSettingMonoAsm(wxCommandEvent& event)
{
    Setting::GetInstance()->SetMonoAsm(event.IsChecked());
}

void wxCam::OnSettingNegativeAsm(wxCommandEvent& event)
{
    Setting::GetInstance()->SetNegativeAsm(event.IsChecked());
}
